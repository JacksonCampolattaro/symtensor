...
ALWAYS_INLINE void get_multipole_derivatives(float& derivative_0, A_3& derivative_1, AA_3& derivative_2, AAA_3& derivative_3, AAAA_3& derivative_4, AAAAA_3& derivative_5, const a_3& point) {
	// 
